...
echo ""
echo "  2) Add to your local ~/.cursor/mcp.json:"
echo "     {"
echo "       \"mcpServers\": {"
echo "         \"postgres-ops\": {"
echo "           \"command\": \"ssh\","
echo "           \"args\": [\"-o\",\"BatchMode=yes\",\"-o\",\"StrictHostKeyChecking=accept-new\","
echo "                     \"-T\",\"root@<SERVER_IP>\","
echo "                     \"cd ${REAL_DOCKER_DIR%/docker} && node tools/mcp-postgres-ops/src/index.js\"]"
echo "         }"
echo "       }"
echo "     }"
echo ""
